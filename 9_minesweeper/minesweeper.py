...
class Board:
    def __init__(self, dim_size, num_bombs):
        ...
        # save (row, col) tuples into the set
        self.dug = set() # if dig 0,0 then self.dug = {(0,0)}
    ...
    def dig(self, row, col):
        ...
        self.dug.add((row, col)) # we already dug here
...
def play(dim_size=10, num_bombs=10):
    ...
    # 4: repeat steps 2 and 3 until are no places to dig (Victory!)
    safe = True
